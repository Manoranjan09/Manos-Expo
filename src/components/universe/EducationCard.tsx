    ...
    <div className="flex h-full flex-col gap-3">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 flex-col items-center gap-2">
          ...
          {/* View Result */}
          <a
            href={education.resultLink}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-[10px] font-medium text-black shadow-[0_8px_25px_-10px_rgba(255,255,255,0.8)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-white/90"
          >
          ...
          return (
            ...
            >
              <div className="relative flex h-[110px] w-full items-end justify-center">
                ...
                <div className="absolute -top-4 text-[9px] font-mono text-white/70">
                  {s.gpa}
                </div>
              </div>
